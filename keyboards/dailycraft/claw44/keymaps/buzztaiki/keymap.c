...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   LT(1,KC_GRV), KC_A   , KC_S   , KC_D   , KC_F   , KC_G   , XXXXXXX, XXXXXXX, KC_H   , KC_J    , KC_K   , KC_L    , LT(3,KC_SCLN), LT(1,KC_QUOT),
    ...
    //`--------+--------+--------+--------+--------+--------/                 \--------+--------+--------+--------+--------+--------'
            GUI_T(KC_SPC), ALT_T(KC_BSPC), _______, TD(TD_SFT_STAB),     _______, _______, ALT_T(KC_MHEN), _______
    //                  `--------+--------+--------+--------'                 `--------+--------+--------+--------'
    ),
    ...
    //|--------+--------+--------+--------+--------+--------|                 |--------+--------+--------+--------+--------+--------|
        KC_TILD, _______, KC_LCBR, KC_LBRC, KC_LPRN, KC_PLUS, _______, _______, KC_MINS, KC_RPRN, KC_RBRC, KC_RCBR, KC_COLN, KC_DQUO,
    //|--------+--------+--------+--------+--------+--------|                 |--------+--------+--------+--------+--------+--------|
        _______, _______, KC_BSLS, KC_PIPE, KC_EQL,  _______, _______, _______, _______, KC_UNDS, KC_LABK, KC_RABK, KC_QUES, _______,
    //`--------+--------+--------+--------+--------+--------/                 \--------+--------+--------+--------+--------+--------'
